...
scat = p + geom_text(data=eq,aes(x = -0.4, y = 1.8,label=V1), size=8, size.unit="pt", parse = TRUE, inherit.aes=FALSE) + facet_wrap(condition~.)
scat
ggsave("../EDA_output/pdf/scatter_additive_combi_Spearman.pdf", scat, width=6.8, height=2, units="in")
ggsave("../EDA_output/png/scatter_additive_combi_Spearman.png", scat, width=6.8, height=2, units="in")
```
...
scat
ggsave("../EDA_output/pdf/scatter_MSA_Transform_proteinNPT.pdf", scat, width=2, height=2, units="in")
ggsave("../EDA_output/png/scatter_MSA_Transform_proteinNPT.png", scat, width=2, height=2, units="in")
...
scat
ggsave("../EDA_output/pdf/scatter_additiveScore_proteinNPT.pdf", scat, width=2, height=2, units="in")
ggsave("../EDA_output/png/scatter_additiveScore_proteinNPT.png", scat, width=2, height=2, units="in")
```
