---
title: "Analysis of Illumina seqeuncing of pooled growth of large CbbM library"
...
relSAS_scores <- read_tsv("../lfcSE_weighted_outputImages/svg/Fig1/Structure_PyMol/relSAS_Gallionella_CbbM-I.tsv")
fitness_data <- left_join(fitness_data, relSAS_scores)

dimer <- read_tsv("../lfcSE_weighted_outputImages/svg/Fig1/Structure_PyMol/dimer_aa.tsv")
...
write_csv(single_muts, "../lfcSE_weighted_outputImages/svg/Fig1/heatMap/single_muts_CLN2.csv")
...
write_csv(single_muts, "../lfcSE_weighted_outputImages/svg/Fig1/heatMap/single_muts_CLO2.csv")
...
write_csv(single_muts, "../lfcSE_weighted_outputImages/svg/Fig1/heatMap/single_muts_LD.csv")
```
