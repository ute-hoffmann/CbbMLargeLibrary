...
if (nrow(df_samplesheet) > 0) {
    message("Saving 'result_notWeighted.Rdata'")
    save(DESeq_result_table, file = "result_notWeighted.Rdata")
    message("Saving 'result_notWeighted.tsv'")
    readr::write_tsv(DESeq_result_table, file = "result_notWeighted.tsv")
}
