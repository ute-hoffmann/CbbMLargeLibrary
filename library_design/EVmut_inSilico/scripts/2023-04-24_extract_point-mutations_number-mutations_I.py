...
path_file = "results/2023-04-24_I_Temperature_0-03_bestSequencesTrajectory.csv"
...
df.to_csv('results/2023-04-24_I_Sequences_Fitness_Point-Mutations.csv', index=False)
