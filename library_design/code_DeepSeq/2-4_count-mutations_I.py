...
path_file_1 = "results/2023-04-20_inSilicoEvolution_I/2023-04-21_I_Sequences_Fitness_Point-Mutations.csv"
data_WT_aa = {}
...
df.to_csv('results/2023-04-20_inSilicoEvolution_I/2023-04-21_I_countMutations_DeepSequence.csv', index=False)
