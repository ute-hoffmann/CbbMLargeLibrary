...
path_directory = "results/2023-04-20_inSilicoEvolution_I/replication_3mutations"
files = os.listdir(path_directory)

data_holder = {"Fitness":[], "Step":[], "Replicate":[], "Sequence":[], "Temperature":[]}
...
df.to_csv("results/2023-04-20_inSilicoEvolution_I/2023-04-21_bestSequencesTrajectory_I.csv", index=False)
